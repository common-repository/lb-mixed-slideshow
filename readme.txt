=== LB Mixed Slideshow for Wordpress ===
...
Tags: slideshow, slide
Requires at least: 2.8
Tested up to: 3.1
Stable tag: 3.0

Easiest way to create a slideshow for Wordpress Blog
...
1. Upload `mixed-slideshow` folder to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Go to "Mixed Slideshow" in left pane
