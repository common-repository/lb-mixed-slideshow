    ...
    if (!Control.ColorPicker.CONTROL) {
      ...
      if (!$("colorpicker")) {
        ...
        control.innerHTML = 
          ...
          '<div id="colorpicker-footer"><span id="colorpicker-value">#<input type="text" style="height:15px;" onclick="this.select()" id="colorpicker-value-input" name="colorpicker-value" value=""></input></span><button id="colorpicker-okbutton">OK</button></div>'
